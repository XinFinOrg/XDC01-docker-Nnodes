...
GETH_ARGS="--datadir /qdata/dd --syncmode full _MINE_ --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul --nodiscover --unlock 0 --password /qdata/passwords.txt --rpcport _RPCPORT_ --port _PORT_ --istanbul.blockperiod=10"
